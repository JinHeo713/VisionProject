...
def parse_args():
    parser = argparse.ArgumentParser(description="ZED 카메라에서 YOLO 객체 감지 실행")
    parser.add_argument('--weights', type=str, default='yolov5s.pt', help='모델 가중치 경로')
