...
usr_conf = 0.3
ground_path = "runs/small/groundtruth.csv"
prediction_path = "runs/small/prediction.csv"
...
if __name__ == '__main__':
    ...
    while True:
        ...
        stacked_frame = frame.copy()
        for name, model in models.items():
        # stacked_frame 위에 바로 그려진 결과를 다시 stacked_frame으로 받아온다!
        ...
        if key == ord('w'):
            ...
            annotated, preds = predict_model(frame, models['WAGO750-1505'], 'WAGO750-1505')
            ...
            annotated, preds = predict_model(frame, models['BK20S-T2'], 'BK20S-T2')
            ...
            annotated, preds = predict_model(frame, models['BS32c-6A'], 'BS32c-6A')
